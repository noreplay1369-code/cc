...
class Openpos_Core
{
    ...
    public function getIgnoreProductTypes($display_variable = false){
        static $cache = array();
        $cache_key = $display_variable ? '1' : '0';
        ...
        $cache[$cache_key] = $ignore_product_types;
        return $ignore_product_types;
    }
    ...
    public function getProducts($args = array(),$display_variable = false)
    {
        ...
        $ignore_product_types = $this->getIgnoreProductTypes($display_variable);
