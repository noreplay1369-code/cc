...
<html>
<head>
    <title><?php echo __('x-report','openpos');?></title>
    <style type="text/css">
        #invoice-POS{
                ...
                <div id="table-info">
					...
					<div id="table">
						<table>
                            ...
                            <tr class="service">
								<td class="tableitem" colspan="2"><p class="tabletitle"><?php echo __('Refund Total','openpos');?></p></td>
								<td class="tableitem"><p class="itemtext"><?php echo wc_price($refund_total); ?></p></td>
                            </tr>
                            <tr class="service">
                    ...
                    <?php if($cash_counter && $cash_counter['total_qty'] > 0):?>
                    <h2><?php echo __('Cash Info','openpos');?></h2>
                    <div class="cash-details">
                        <table>
                                <tr class="tabletitle">
                                    <td class="item"><h2><?php echo __('Cash','openpos');?></h2></td>
                                    <td class="Hours"><h2><?php echo __('Qty','openpos');?></h2></td>
                                    <td class="Rate"><h2><?php echo __('Total','openpos');?></h2></td>
                                </tr>
                                
                                <?php foreach($cash_counter['details'] as $item): ?>
                                    <tr class="service">
                                        <td class="tableitem"><p class="itemtext"><?php echo $item['label']; ?></p></td>
                                        <td class="tableitem"><p class="itemtext"><?php echo $item['qty']; ?></p></td>
                                        <td class="tableitem"><p class="itemtext"><?php echo wc_price($item['qty'] * $item['value']); ?></p></td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr class="tabletitle">
                                    <td class="item"><h2><?php echo __('Total','openpos');?></h2></td>
                                    <td class="Hours"><?php echo $cash_counter['total_qty'];?></td>
                                    <td class="Rate"><?php echo wc_price($cash_counter['total']);?></td>
                                </tr>
